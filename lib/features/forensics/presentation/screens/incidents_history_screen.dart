...
class _IncidentCard extends StatelessWidget {
  ...
  String get _summary {
    if (incident.analysisIsPartial) {
      ...
      return l10n.incidentPartialSummary(score);
    }
    final reasons = incident.threatReasons
        .where((r) => r != 'No significant threat indicators')
        .take(2)
        .map((r) => localizeThreatReason(l10n, r))
        .join(' + ');
    return reasons.isEmpty ? l10n.incidentNoThreats : reasons;
  }
        ...
        child: Column(
          ...
          children: [
            Icon(Icons.receipt_long_outlined,
                size: 56, color: p.borderSubtle),
            const SizedBox(height: 16),
            Text(l10n.incidentEmptyTitle, style: AppTypography.titleMedium),
            const SizedBox(height: 8),
            Text(
              l10n.incidentEmptyBody,
